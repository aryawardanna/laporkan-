...
<body class="leading-normal tracking-normal" style="font-family: 'Montserrat', sans-serif">
  ...
  <nav class="flex items-center justify-between flex-wrap bg-purple-400 p-7 px-20">
    <div class="flex items-center flex-shrink-0 text-black mr-6 w-32">
      <img src="{{ asset('img/logo.svg')}}" alt=""
        class="transform transition hover:scale-100 duration-300 ease-in-out" />
      <span class="font-bold tracking-wider text-2xl text-pink-700">
        &nbsp LAPORKAN!</span>
    </div>
    ...
    <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto text-center">
      <div class="text-md lg:flex-grow">
        <a href="/" class="block mt-4 lg:inline-block lg:mt-0 text-black mr-4 text-xl font-medium">
          Home
        </a>
        <a href="#how" class="block mt-4 lg:inline-block lg:mt-0 text-black mr-4 text-xl font-medium">
          Tata Cara
        </a>
      </div>
      <div>
        <button
          class="text-black font-medium rounded-md py-3 border-black px-4 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out text-xl ">
          <a href="{{ url('login')}}">Masuk</a>
        </button>
        <button
          class="text-pink-800 font-medium rounded-md py-3 px-4 border-2 border-white focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out text-xl">
  ...
  <!--Hero-->
  <div class="pt-24 px-16 bg-purple-400">
    <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
      ...
      <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left text-gray-800">
        <h1 class="my-4 text-4xl font-bold leading-tight">
          Layanan Pengaduan Masyarakat Desa
        </h1>
        ...
        <button
          class="mx-auto lg:mx-0 bg-pink-600 text-white font-bold rounded-md my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
  ...
  <footer class="text-center font-medium bg-purple-400 py-5">
    © 2021 LAPORKAN! | By
    <a href="#" class="text-pink-800" target="_blank">Arya Wardana</a>
  </footer>
